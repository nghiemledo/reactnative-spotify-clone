...
interface AlbumItemProps {
  hanldeNavigation: <T extends keyof RootStackParamList>(screen: T, params?: RootStackParamList[T]) => void;
  item: Album;
  getArtistName: (id: string) => string;
}

export const AlbumItem = ({ hanldeNavigation, item, getArtistName }: AlbumItemProps) => {

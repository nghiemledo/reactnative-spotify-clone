...
import { postAlbumData } from '@/store/album/album.actions';
...
const ManageAddAlbum: React.FC = () => {
    ...
    const onSubmit: SubmitHandler<FormValues> = async (data) => {
        ...
        try {
            await dispatch(postAlbumData(payload)).unwrap();
            toast("Success!", {
    ...
    return (
        <div className='container mx-auto'>
            <div className="mb-5 flex items-center justify-between space-y-2">
                <h1 className="text-2xl font-bold tracking-tight">Add Album</h1>

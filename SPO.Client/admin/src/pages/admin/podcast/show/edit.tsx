...
import { getPodcastShowById, putPodcastShowData } from '@/store/podcast-show/podcast-show.actions';
...
const ManageEditPodcastShow: React.FC = () => {
    ...
    useEffect(() => {
        if (podcastShowDetail) {
            setValue('title', podcastShowDetail.title);
            setValue('creator', podcastShowDetail.creator);
            setValue('description', podcastShowDetail?.description || "");
            setValue('coverImage', podcastShowDetail.coverImage || '');
            setValue('categoryId', podcastShowDetail.categoryId || '');
        }
    }, [podcastShowDetail, setValue]);
    ...
    const onSubmit: SubmitHandler<FormValues> = async (data) => {
        ...
        const payload = {
            ...
            createdAt: podcastShowDetail?.createdAt || new Date().toISOString(),
            updatedAt: new Date().toISOString(),
        };
        try {
            await dispatch(putPodcastShowData(payload)).unwrap();
            toast('Success!', {
                description: 'Podcast show has been updated successfully.',
            });
            navigate('/admin/podcast-shows');
        } catch {
            toast('Error', {
                description: 'Failed to update podcast show. Please try again.',
            });
        }
    };
    ...
    return (
        <div className="container mx-auto">
            <div className="mb-5 flex items-center justify-between space-y-2">
                <h1 className="text-2xl font-bold tracking-tight">Edit Podcast Show</h1>
...
export default ManageEditPodcastShow;
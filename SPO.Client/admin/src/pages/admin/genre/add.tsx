...
import { postGenreData } from '@/store/genre/genre.actions';
...
const ManageAddGenre: React.FC = () => {
    ...
    const onSubmit: SubmitHandler<FormValues> = async (data) => {
        ...
        try {
            await dispatch(postGenreData(payload)).unwrap();
            toast("Success!", {
    ...
    return (
        <div className='container mx-auto'>
            <div className="mb-5 flex items-center justify-between space-y-2">
                <h1 className="text-2xl font-bold tracking-tight">Add Genre</h1>
                ...
                <CardContent className="pt-6">
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            />
                            <p className="text-sm text-muted-foreground">A brief description of the genre. This is optional.</p>
                        </div>

...
import { postPlaylistData } from '@/store/playlist/playlist.actions';
...
const ManageAddPlaylist: React.FC = () => {
    ...
    const onSubmit: SubmitHandler<FormValues> = async (data) => {
        ...
        try {
            await dispatch(postPlaylistData(payload)).unwrap();
            toast("Success!", {
    ...
    return (
        <div className='container mx-auto'>
            <div className="mb-5 flex items-center justify-between space-y-2">
                <h1 className="text-2xl font-bold tracking-tight">Add Playlist</h1>
...
export default ManageAddPlaylist;